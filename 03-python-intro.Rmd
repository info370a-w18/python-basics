...
![Interactive Python session](imgs/01-img/python-interactive-session.png)
...
![Run Python script from terminal](imgs/01-img/python-terminal.png)
...
![Opening notebook animation, from the official documentation](imgs/01-img/new-notebook.gif)
